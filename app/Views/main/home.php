<main class="w-full mx-auto mt-14 md:mt-24">
    <!-- Image Slider -->
    ...
    <div class="container mx-auto md:px-4 md:py-6 my-5">
    ...
    <div class="container mx-auto px-4 py-2 md:py-6">
        <div class="text-center">
            <h1 class="text-xl md:text-3xl font-bold">Produk & Layanan</h1>
            <!-- Bouncing dots -->
    ...
    <div class="container mx-auto px-4 py-2 md:py-6">
        <div class="text-center">
            <h1 class="text-xl md:text-3xl font-bold">Galeri Aktivitas</h1>
            <!-- Bouncing dots -->
            <div class="flex justify-center gap-2 mt-3 h-5">
                <span class="w-3 h-3 bg-blue-600 rounded-full animate-bounce [animation-delay:0ms]"></span>
                <span class="w-3 h-3 bg-blue-600 rounded-full animate-bounce [animation-delay:200ms]"></span>
        ...
        <div x-data="sliderGallery()" x-init="init()" class="w-full my-5 md:my-10">
            <div class="swiper">
