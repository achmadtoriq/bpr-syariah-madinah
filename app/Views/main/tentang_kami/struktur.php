<main class="w-full mx-auto mt-14 md:mt-24 py-1">
    <div class="container mx-auto my-5 md:my-10 p-2">
        <div class="text-center">
            <h1 class="text-xl md:text-3xl font-bold">Struktur Organisasi</h1>
            <!-- Bouncing dots -->
        ...
        <div class="my-7 md:my-14 rounded-md shadow-sm">
            <img src="<?= base_url('/assets/struktur_bprs.png')?>" alt="" class="mx-auto">
        </div>
    </div>
</main>